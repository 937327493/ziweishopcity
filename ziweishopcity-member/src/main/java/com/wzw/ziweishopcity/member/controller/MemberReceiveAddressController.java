...
import com.wzw.ziweishopcity.member.service.MemberReceiveAddressService;
...
public class MemberReceiveAddressController {
    ...
    public List<MemberReceiveAddressEntity> addresses(@PathVariable("username") String username) {
        return memberReceiveAddressService
                .list(new QueryWrapper<MemberReceiveAddressEntity>()
                        .eq("name",username ));
    }
